          ...
          <div className="col-lg-3 col-xl-3 section__col">
            ...
            >
              ...
              <div className="profile__tab-programs-tab-3">
                <p className="secondary-text"><b>Group Lesson-Introduction To Pickleball</b></p>
                <p><b><Image src="/images/profile/calendar-blue.png" alt="Calendar" className="calendar" width={48} height={48} /> Wed, Feb 14 - Tue, Dec 31 </b></p>
              </div>
            </div>
          </div>
  );
